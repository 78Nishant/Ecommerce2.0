...
const productcard = () => {
  return (
    <div className='bg-[#fffafa] border  drop-shadow-xl h-1/3 w-1/6 text-black mt-5 ml-5 mb-10 rounded-xl  '>
      ...
      <img className='border rounded-t-xl bg-gray-100 w-full' src="https://static.vecteezy.com/system/resources/thumbnails/013/143/819/small/blue-running-sneaker-on-blue-background-close-up-photo.jpg" alt="image _here" />
      </span>
        ...
        <p className='font-bold mt-2'>₹600</p>
          ...
          {/* buttons */}
            <div className='text-white flex w-full mt-3 justify-start gap-7'>
              <button className='bg-red-500 w-1/3 h-7 rounded-md flex'>
                <p className='ml-2'>cart</p>
                <FaShoppingCart  className='h-full w-5 ml-5'/>
              </button>
              <button className='bg-blue-500 w-1/3 rounded-md flex'>
                <p className='ml-2'>cart</p>
